...
public final class FillSIPRegistrationForm {
    ...
    private static final String sourcePayEezzFile = Util.getDirectoryPath() + "\\CTF-SIP-Fillable.pdf";
...
//            Util.printPdfOutput2(destinationFile,NAME+"SIP_REG");
    ...
    private static void fillFromExcel(Util util) throws Exception {
        ...
        SIP1_START_MONTH = util.getCellValue(15);
        SIP1_START_YEAR = util.getCellValue(16);
        SIP1_AMOUNT = util.getCellValue(17);
        SIP2_AMC = util.getCellValue(18);
        SIP2_FOLIO = util.getCellValue(19);
        SIP2_SCHEME = util.getCellValue(20);
        SIP2_START_MONTH = util.getCellValue(21);
        SIP2_START_YEAR = util.getCellValue(22);
        SIP2_AMOUNT = util.getCellValue(23);
        SIP3_AMC = util.getCellValue(24);
        SIP3_FOLIO = util.getCellValue(25);
        SIP3_SCHEME = util.getCellValue(26);
        SIP3_START_MONTH = util.getCellValue(27);
        SIP3_START_YEAR = util.getCellValue(28);
        SIP3_AMOUNT = util.getCellValue(29);
        SIP4_AMC = util.getCellValue(30);
        SIP4_FOLIO = util.getCellValue(31);
        SIP4_SCHEME = util.getCellValue(32);
        SIP4_START_MONTH = util.getCellValue(33);
        SIP4_START_YEAR = util.getCellValue(34);
        SIP4_AMOUNT = util.getCellValue(35);
        SIP5_AMC = util.getCellValue(36);
        SIP5_FOLIO = util.getCellValue(37);
        SIP5_SCHEME = util.getCellValue(38);
        SIP5_START_MONTH = util.getCellValue(39);
        SIP5_START_YEAR = util.getCellValue(40);
        SIP5_AMOUNT = util.getCellValue(41);
